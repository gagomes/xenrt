...
from xenrt.lib.xenserver.dockercontainer import *
...
class TCSanityTest(xenrt.TestCase):
    ...
    def run(self, arglist=None):
        ...
        containers = [
            GenericContainer(ContainerNames.BUSYBOX, self.host, self.coreos, UsingXapi()),
            GenericContainer(ContainerNames.BUSYBOX, self.host, self.coreos, UsingCoreOS())
            ]
