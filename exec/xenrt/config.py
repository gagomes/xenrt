...
class Config(object):
    ...
    def addAllHotfixes(self):
        ...
        self.config["CARBON_PATCHES_SANIBEL"]["HF47"] = self.config["HOTFIXES"]["Sanibel"]["RTM"]["XS602E047"]
        ...
        if branch == "RTM":
            ...
            self.config["CARBON_PATCHES_CLEARWATER"]["HF33"] = self.config["HOTFIXES"]["Clearwater"]["SP1"]["XS62ESP1033"]
