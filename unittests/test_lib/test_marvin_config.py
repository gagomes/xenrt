...
class TestMarvinConfig(XenRTUnitTestCase):
    ...
    DEFAULT_VARS = {"NETWORK_CONFIG/DEFAULT/NAMESERVERS": "10.0.0.2",
                    ...
                    "AD_CONFIG": {"ADMIN_USER": "Administrator", "ADMIN_PASSWORD": "xenroot01T", "DOMAIN_NAME": "XSQA", "DOMAIN": "ad.qa.xs.citrite.net", "DNS": "10.220.254.115", "DC_ADDRESS": "10.220.254.115", "DC_DISTRO": "ws12-x64", "USERS": {"CIFS_USER": "cifsuser:xenroot02T"}},
