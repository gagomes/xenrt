...
class TestGenericPlace(XenRTUnitTestCase):
    ...
    def test_getwindowsnetshconfig_validcmd_returnexpected(self, parse):
        """
        Given a clean windows environment , when netsh configuration
        information is provided with xmlrpc support,
    ...
    def __test_getwindowsipconfigdata_validinput_returnexpected(self, data):
        """
        Given clean windows environment , when xmlrpcexec support is provided,
        then parsed ipconfig data is returned
        """
    ...
    def test_getwindowsinterface_validinput_returninterface(self):
        """
        Given a clean windows environment ,when ip configuration data is
        provided, then interface is returned
        """
