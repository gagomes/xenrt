...
class TestRHELLinuxOverrides(XenRTUnitTestCase):
    ...
    def testIsoNameImplementation(self):
        ...
        data = {("rhel38_x86-32", "rhel38_x86-32.iso"), 
                ("rhel5_x86-64", "rhel5_x86-64.iso"), 
                ("rhel6_x86-32", "rhel6_x86-32.iso"), 
                ("rhel6_x86-64", "rhel6_x86-64.iso"), 
                ("rhel65_x86-32", "rhel65_x86-32.iso"), 
                ("rhel65_x86-64", "rhel65_x86-64.iso"),
                ("hopkins", None)}
...
class TestCentOSLinuxOverrides(XenRTUnitTestCase):
    ...
    def testIsoNameImplementation(self):
        ...
        data = {("centos43_x86-32", "centos43_x86-32.iso"), 
                ("centos43_x86-64", "centos43_x86-64.iso"), 
                ("centos6_x86-32", "centos6_x86-32.iso"), 
                ("centos6_x86-64", "centos6_x86-64.iso"), 
                ("centos65_x86-32", "centos65_x86-32.iso"), 
                ("centos65_x86-64", "centos65_x86-64.iso"), 
                ("prestige", None)}
...
class TestOELLinuxOverrides(XenRTUnitTestCase):
    ...
    def testIsoNameImplementation(self):
        ...
        data = {("oel510_x86-32", "oel510_x86-32.iso"),
                ("oel6_x86-32", "oel6_x86-32.iso"),
                ("oel6_x86-64", "oel6_x86-64.iso"),
                ("oel65_x86-32", "oel65_x86-32.iso"), 
                ("oel65_x86-64", "oel65_x86-64.iso"),
                ("tiffael", None)}
