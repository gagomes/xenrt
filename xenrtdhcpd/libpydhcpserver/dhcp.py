...
class _NetworkLink(object):
    ...
    def __init__(self, server_address, server_port, client_port, pxe_port, response_interface=None, response_interface_qtags=None):
        ...
        (dhcp_socket, pxe_socket) = self._setupListeningSockets(server_port, pxe_port, response_interface)
        if pxe_socket:
    ...
    def _setupListeningSockets(self, server_port, pxe_port, interface):
        """
        ...
        try:
            dhcp_socket.setsockopt(socket.SOL_SOCKET, 25, interface)
